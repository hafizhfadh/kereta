        ...
        <div class="card-content">
          <form class="form-vertical" action="{{ route('buy-ticket') }}" method="post">
            ...
            <div class="field">
              ...
              <div class="control">
                <input type="text" name="nama_customer" class="input" require>
              </div>
            </div>
            <div class="field">
              <label class="label">Nama Kereta</label>
              <div class="control">
                <select class="input" type="text" name="nama_kereta" id="trains" require></select>
              </div>
            </div>
            <div class="columns">
              <div class="column">
                <div class="field">
                  ...
                  <div class="control">
                    <select class="input" type="text" placeholder="Stasiun Asal" name="stasiun_keberangkatan" id="dari" require></select>
                  </div>
                </div>
              </div>
              ...
              <div class="column">
                <div class="field">
                  ...
                  <div class="control">
                    <select class="input" type="text" placeholder="Stasiun Asal" name="stasiun_kedatangan" id="ke" require></select>
                  </div>
                </div>
              </div>
            </div>
            <div class="columns">
              <div class="column">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="date" name="waktu_keberangkatan" require>
                  </div>
                </div>
              </div>
